               ...
               <div class="col-sm-10 offset-sm-1 col-md-8 offset-md-2">
                  ...
                  <div class="mb-4 d-sm-flex justify-content-sm-between">
                     ...
                     <div class="d-none d-sm-block">
                        <button type="button" class="btn btn-danger float-right" onclick="fn_claimModal('${place.placeNo}');">신고</button>

                        <c:if test="${loginMember.memberNo ne place.memberNo }">
                           <!-- 팔로우 버튼 -->                        
                  ...
                  <div class="d-sm-none mb-3">
                     ...
                     <button type="button" class="btn btn-danger" onclick="fn_claimModal('${place.placeNo}');">신고</button>>신고</button>

...
//사진 미리보기
 $(document).on('change','.upload',function(e){           
       $.each(e.target.files,(i,v)=>{//미리보기 로직         
           ...
           reader.onload=e=>{                              
               let img=` <div class="imgBox position-relative rounded col-12 p-0">              		
			                <img src="`+e.target.result+`" class="col-12 p-0 rounded previewImg" style="width:100%;">	
			                <div class="buttonCon position-absolute rounded" style="bottom:0; left:0; background:linear-gradient(to top,rgba(0, 0, 0, 0.5),rgba(255, 255, 255, 0)); width:100%;">
...
$(".updatePic").on("change",e=>{
	let img=$(e.target).parents(".imgBox").find(".previewImg");

          ...
          <%}else{
           ...
           <article class="px-4 mb-3 pb-3 border-bottom">
             <div class="pl-2 d-flex justify-content-between">
              <div class="row">
                <a href="${path }/user/moveUserInfo.do?memberNo="+<%=r.getMemberNo() %>" class="rounded-circle pr-3">
             ...
             <%if(r.getFileName()!=null){ %>
              <a href="javascript:fn_rvPic('<%=r.getFileName() %>');">
		  ...
		  <div class="modal-dialog  modal-dialog-centered">
		    <div class="modal-content">
		      ...
		      <div class="modal-body offset-1 col-10 pb-0 mt-2 mb-4">
		       <div class="rounded">
		       		<img class="rounded" src="${path }/resources/upload/store/review/`+filename+`" width="100%"> 
		        </div> 

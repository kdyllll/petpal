        ...
        <div class="accordion" id="accordionExample">
          ...
          <div class="card border-0">
            <div class="card-header bg-transparent" id="headingOne">
              <h2 class="mb-0">
                <button class="btn btn-link btn-block text-left text" style="font-weight: bold;" type="button"
          ...
          <div class="card border-0">
            <div class="card-header bg-transparent" id="headingTwo">
              <h2 class="mb-0">
                <button class="btn btn-link btn-block text-left collapsed" style="font-weight: bold;" type="button"
      ...
      <div class="col-lg-9">
        ...
        <div id="carouselExampleIndicators" class="carousel slide my-5" data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
              <img class="d-block img-fluid" src="sea)연어.png" alt="First slide" style="height:350px; width:100%">
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="sea)연어.png" alt="Second slide" style="height:350px; width:100%">
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="sea)연어.png" alt="Third slide" style="height:350px; width:100%">
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-12 category-container mt-5">
            <h5 style="font-weight: bold;">강아지</h5><a class="text-info" style="font-weight: bold;" href="#">더보기</a>
          </div>
          <div class="col-lg-4 col-md-6 mb-4">
            <a href="#">
              <img class="card-img-top" src="resources/images/common3.jpg" alt="">
          ...
          <div class="col-12 category-container mt-5">
            <h5 style="font-weight: bold;">고양이</h5><a class="text-info" style="font-weight: bold;" href="#">더보기</a>
          </div>
          <div class="col-lg-4 col-md-6 mb-4">
            <a href="#">
          ...
          <div class="col-12 category-container mt-5">
            <h5 style="font-weight: bold;">소동물</h5><a class="text-info" style="font-weight: bold;" href="#">더보기</a>
          </div>
          <div class="col-lg-4 col-md-6 mb-4">
            <a href="#">
              <img class="card-img-top" src="sea)연어.png" alt="">

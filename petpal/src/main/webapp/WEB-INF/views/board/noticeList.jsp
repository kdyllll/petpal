   	...
   	<div class="container" style="max-width:940px">
      		...
      		<div class="form-inline mb-5">
	   		...
	   		<c:forEach items="${list }" var="n">
	   			<div class="d-block detail border-top form-inline pt-4 pb-4" style="color:black; cursor:pointer">
		   			<div class="d-flex justify-content-between">
						...
						<fmt:parseDate value="${n.WRITEDATE }" var="nw" pattern="yyyy-MM-dd"/>
						<div><fmt:formatDate value="${nw }" pattern="yyyy년MM월dd일"/></div>
		   			</div>
	   			</div>	

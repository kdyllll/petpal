      		...
      		<div class="form-inline mb-5">
	   		...
	   		<c:forEach items="${list }" var="q">
	   			<c:if test="${not loop_flag }">
		   			<c:choose>
		   				<c:when test="${empty q.MAINIMG}">
		   					<c:set var="loop_flag" value="true" />
	   					
		   					<div class="border-top form-inline pt-4 pb-4">
					   			<div class="col-sm-10 col-8">
						   			<a href="${path }/board/questionDetail.do?questionNo=${q.QUESTIONNO}" style="color:black">
							   			<h5 class="font-weight-bold"><c:out value="${q.TITLE }"/></h5>
							   			<div class="d-sm-inline d-none">
								   			<p class="small">
								   				<c:out value="${q.CONTENT1 }"/>
								   			</p>
						   				</div>
						   			</a>
							   		<h6 class="d-inline mr-3">작성자</h6>
							   		<h6 class="d-inline small mr-5"><c:out value="${q.WRITEDATE }"/></h6>
							   		<div class="d-block d-sm-inline">
							   			<h6 class="d-inline small mr-3">#해시태그</h6>
							   			<h6 class="d-inline small mr-3">#해시태그</h6>
							   			<h6 class="d-inline small mr-3">#해시태그</h6>
			   			...
			   			<div class="image col-sm-2 col-2">
			   				<img src="${path }/resources/upload/question/${q.MAINIMG}" width="130px" height="130px">
			   			</div>
			   		</div>
		   				</c:when>
		   			</c:choose>

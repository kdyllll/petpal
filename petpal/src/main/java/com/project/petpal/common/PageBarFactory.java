...
public class PageBarFactory {
	...
	public static String getPageBar2(int totalData,int cPage,int numPerpage,String category,String sort,String uri) {
		...
		pageBar+="<script>";
		pageBar+="function fn_paging(cPage){";
		pageBar+="location.href='"+uri+"?cPage='+cPage"+(category==null?"":"+'&category="+category+"'")+(sort==null?"":"+'&sort="+sort+"'");
		pageBar+="}";
		pageBar+="</script>";
		return pageBar;
	}
